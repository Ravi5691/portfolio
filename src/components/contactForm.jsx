...
const ContactForm = () => {
  ...
  return (
    <div className="w-screen font-mono m-10 mt-5 flex ml-20">
    <div className=" m-20 w-[30%] p-8 pb-10 shadow-md rounded-2xl border-2 border-[rgba(255,255,255,0.71)] relative">
