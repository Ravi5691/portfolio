...
function CardDescription({ className, children }) {
  return (
    <p
      className={cn(
        "lg:mt-4 mt-0 pb-2 text-zinc-400 lg:tracking-wide tracking-normal lg:leading-relaxed leading-1 lg:text-sm text-[10px] ",
        className
      )}
    >
      {children}
...
const projects = [
  {
    ...
    description:
      "This project is focused on practicing canvas animation techniques and integrating GSAP ScrollTrigger for scroll-based animations. It combines GSAP's powerful animation capabilities for interactive user experiences.",
  ...
  },
  {
    title: "Netflix Clone",
    description:
      "This project is my first attempt at creating a Netflix clone using HTML and CSS, focusing on layout design and responsive elements to replicate the platform's user interface.",
  ...
  },
  {
    title: "Weather App",
    description:
      "This project is created to practice API handling, using the Weather API to retrieve information and incorporating a location attribute for more personalized data retrieval.",
    // link: "https://meta.com",
